...
* Check mapping (LOOK AT THIS OUTPUT).
  FREQUENCIES VARIABLES=urban urban_num.

* Create dummies (ADJUST if mapping differs).
...
*-----------------------------*
* 5. RELIABILITY (OPTIONAL BUT GOOD)
*-----------------------------*
...
*-----------------------------*
* 7. EXTENDED MODEL (SYSTEMIC EFFECTS)
  *-----------------------------*
...
RECODE D3
(1 2 3 = 1)   /* Primary + Basic + Secondary */
(4 = 2)       /* Semi-higher */
(5 6 7 = 3)   /* Higher education */
INTO edu_group.
